...
`git clone https://github.com/ByteLegendQuest/java-refactor-to-more-base-classes`

A project directory named `java-refactor-to-more-base-classes` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-refactor-to-more-base-classes` directory which is created just now.
